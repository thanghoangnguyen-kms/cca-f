...
| `06 - Youtube Course/EP<NN> - .../EP<NN> - Flashcards.md` | One episode | Dedupe against the vault-wide deck, and **name the skipped topics in the deck's header callout** so exclusions read as deliberate, not missed |
...
- **Scope of work:** episode tasks write to `06 - Youtube Course/` only. Do **not** launch a background audit of `01`–`05`, and don't "reconcile" verified notes to match a video.
